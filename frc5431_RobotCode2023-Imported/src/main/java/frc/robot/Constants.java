...
//    public static final int ID_PIGEON2 = 13;
    public static final int ID_PIGEON2 = 18; // put back to 2
...
//    public static final String CANBUS_SUBSYSTEM = "";
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.617;
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.617;
// remarks are for 2024 bot     
...
//    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0); // test1 +120 \ test2 +135 \ test3 -60
//    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(62.051);
    public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 3;
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 4;
    public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 10;
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(232.295/2.0);
...
//    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0);  // test1 -15 \ test2 -170 \ test3 +165
//    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(247.236);
    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 1;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 2;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 9;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(77.607/2.0);
...
//    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(52.471);
    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 5;
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 6;
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 11;
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(52.646/2.0);

//    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 41;
//    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 42;
...
//    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(193.184);
    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 7;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 8;
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 12;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(164.0918 / 2.0);
