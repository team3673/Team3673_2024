// Don't think this will help. I can't figure out the problem - Brodie Wozniak
/*
...
public class Vision extends SubsystemBase {
  ...
  /*   public Vision(Drivebase drivebase) {
        ...
        try    {
             // Don't think this will help. I can't figure out the problem - Brodie Wozniak editing done by Isaiah Salinas
