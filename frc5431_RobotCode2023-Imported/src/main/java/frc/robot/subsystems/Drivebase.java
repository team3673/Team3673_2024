...
public class Drivebase extends SubsystemBase {
     ...
     */
    // [past notes] changed MAX_VELOCITY_METERS_PER_SECOND from 6380.0 (original) to 9.99996984 (is 32.8083 in feet)
    // and changed L2 to L1  
    // Diego changed 9.0 to 5676 and then * Math.PI by 0.90
    public static final double MAX_VELOCITY_METERS_PER_SECOND = 5676.0 / 60.0 *
                    SdsModuleConfigurations.MK4_L1.getDriveReduction() *
                    SdsModuleConfigurations.MK4_L1.getWheelDiameter() * Math.PI * 0.10;
    /**
...
//        pigeon2 = new WPI_Pigeon2(ID_PIGEON2, CANBUS_DRIVETRAIN);
        pigeon2 = new WPI_Pigeon2(ID_PIGEON2);
...
//                .withDriveMotor(MotorType.FALCON, FRONT_LEFT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
                .withDriveMotor(MotorType.NEO, FRONT_LEFT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
//                .withSteerMotor(MotorType.FALCON, FRONT_LEFT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
                .withSteerMotor(MotorType.NEO, FRONT_LEFT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
...
//                .withDriveMotor(MotorType.FALCON, FRONT_RIGHT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
                .withDriveMotor(MotorType.NEO, FRONT_RIGHT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
//                .withSteerMotor(MotorType.FALCON, FRONT_RIGHT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
                .withSteerMotor(MotorType.NEO, FRONT_RIGHT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
...
//                .withDriveMotor(MotorType.FALCON, BACK_LEFT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
                .withDriveMotor(MotorType.NEO, BACK_LEFT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
//                .withSteerMotor(MotorType.FALCON, BACK_LEFT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
                .withSteerMotor(MotorType.NEO, BACK_LEFT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
...
//                .withDriveMotor(MotorType.FALCON, BACK_RIGHT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
                .withDriveMotor(MotorType.NEO, BACK_RIGHT_MODULE_DRIVE_MOTOR, CANBUS_DRIVETRAIN)
//                .withSteerMotor(MotorType.FALCON, BACK_RIGHT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
                .withSteerMotor(MotorType.NEO, BACK_RIGHT_MODULE_STEER_MOTOR, CANBUS_DRIVETRAIN)
...
//        System.out.println("Gyro = " + pigeon2.getRotation2d().getDegrees());
    ...
    public double getAngle(int module) {
        ...
        switch(module) {
            case 0:
                angle = m_frontLeftModule.getSteerAngle() / Math.PI * 180.0;
                break;
            case 2:
                angle = m_frontRightModule.getSteerAngle() / Math.PI * 180.0;
                break;
            case 4:
                angle = m_backLeftModule.getSteerAngle() / Math.PI * 180.0;
                break;
            case 6:
                angle = m_backRightModule.getSteerAngle() / Math.PI * 180.0;
                break;      
        }
        return angle;
    }
...
/*     public List<WPI_TalonFX> getMotors() {
    ...
    public List <CANSparkMax> getMotors() {
        List <CANSparkMax>  retval = new ArrayList<>();
        for (SwerveModule s : new SwerveModule[]{ m_frontLeftModule, m_frontRightModule, m_backLeftModule, m_backRightModule }) {
            retval.add((CANSparkMax) s.getSteerMotor());
            retval.add((CANSparkMax) s.getDriveMotor());
        }
        return retval;
    }  
    ...
    public void periodic() {
        ...
        // Hockey-lock if stopped by setting rotation to really low number
